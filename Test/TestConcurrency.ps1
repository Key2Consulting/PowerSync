Start-PSYActivity -Name 'Test Concurrency' -ScriptBlock {
    ...
    Start-PSYActivity -Name 'Test Parallel Race Execution' -ScriptBlock ({
    ...
    Start-PSYForEachActivity -Name 'Test ForEach Incorrect Concurrency Execution' -InputObject (1..10) -Throttle 5 -ScriptBlock {
    ...
    Set-PSYVariable 'TestVariable' 0
    Start-PSYForEachActivity -Name 'Test ForEach Correct Concurrency Execution' -InputObject (1..10) -Throttle 5 -ScriptBlock {
