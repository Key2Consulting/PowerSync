Start-PSYActivity -Name 'Test SQL to SQL' -ScriptBlock {
    ...
    Start-PSYActivity -Name 'Large Types' -ScriptBlock {
        ...
        | Import-PSYSqlServer -Connection "TestDbSqlServer" -Table "dbo.LargeTypes" -AutoCreate -AutoIndex
    }
    Start-PSYActivity -Name 'Big Table' -ScriptBlock {
        ...
        | Import-PSYSqlServer -Connection "TestDbSqlServer" -Table "dbo.BigTable" -AutoCreate
    }    
    Start-PSYActivity -Name 'Big Table Type Conversion' -ScriptBlock {
        ...
        | Import-PSYSqlServer -Connection "TestDbSqlServer" -Table "dbo.BigTableTypeConversion" -AutoCreate
    }    
}