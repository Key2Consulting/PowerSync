...
.DESCRIPTION
This function is only required if parallel execution is performed by the project. Registering the module informs PowerSync to load that module during parallel
execution.
