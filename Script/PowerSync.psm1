...
#Import-Module ".\Script\Activity\Start-MainActivity.psm1"
#Export-ModuleMember -Function 'Start-MainActivity'

# Search and import all our source our files using dot sourcing technique
try {
    ...
    throw "Unable to import PowerSync source files."
}